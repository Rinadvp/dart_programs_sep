...
void func3(int a,int b){ ///(parameterts can be int,string, double,bool,list etc)
...
int func4(int a, String b,double c){
  ...
  return a; // here u can return parameter , local variables or any value the
...
///lamda function without return type and without parameter
