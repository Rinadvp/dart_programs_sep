void main() {
 var list1 = List.empty(
     growable: true); // list.empty() is basically a fixed length list since value of growable : false
 ...
 var list3 = List.from(
     list1); // list from() we are creating a list from another list or set etc and it
